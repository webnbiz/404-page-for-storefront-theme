		...
		<main id="main" class="site-main" role="main">
			...
			<div class="error-404 not-found">
				...
				<div class="page-content">
					...
					<p><?php esc_html_e( 'Hi there, The page you are looking for does not exist. Try searching, or check out the links below, and explore by categories', 'storefront' ); ?>
					...
					<h3>Explore By Categories </h3></p>
					<?php 
					$categories = get_categories();
					foreach($categories as $category) {
					   echo '<a style="margin:2px;" class="button" href="' . get_category_link($category->term_id) . '">' . $category->name . '</a>' . ' ' ;
					} ?>
